...
#line 959 "lpmln_parser.c"
        break;
      case 4: /* atom ::= identifier */
#line 93 "lpmln_parser.y"
{
...
#line 991 "lpmln_parser.c"
        break;
      case 6: /* predicate ::= identifier */
#line 119 "lpmln_parser.y"
{
    parsetoken new_parsetoken;
    new_parsetoken.text = yymsp[0].minor.yy84->last;
    new_parsetoken.type = CONSTRUCT_PREDICATE;
...
#line 135 "lpmln_parser.y"
{
    HANDLER_DISJUNCTION()
}
#line 1021 "lpmln_parser.c"
        break;
...
#line 206 "lpmln_parser.y"
{
    HANDLER_IMPLICATION()
}
#line 1048 "lpmln_parser.c"
        break;
